...
CASE_DIR = '/data/datasets/wkq_vlm/gagi/eve_v2_outputs/selfcase/mine_round0/case_bank'
...
config = dict(
    ...
    project_dir='/data/datasets/wkq_vlm/gagi/eve_v2_outputs/t4g_selfcase/experiments',
    launch=dict(
