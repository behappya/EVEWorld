...
#   /data/datasets/wkq_vlm/gagi/eve_v2_outputs/t4g_selfcase/experiments/models/checkpoint_epoch_125_step_250/transformer_ema
...
set -eu
REPO=giga-world-0
MODEL_DIR=/data/datasets/wkq_vlm/gagi/eve_v2_outputs/t4g_selfcase/experiments/models/a1_s250_infer_modeldir
OUT_ROOT=/data/datasets/wkq_vlm/gagi/eve_v2_outputs/selfcase/pool_a1_s250_f93
...
kjobctl create slurm --profile slurm-profile \
  ...
  -- \
  "$REPO/scripts/kjob_bestofn_8gpu.sh" \
  "REPO_DIR=$REPO" \
  "MODEL_DIR=$MODEL_DIR" \
  "OUT_ROOT=$OUT_ROOT" \
