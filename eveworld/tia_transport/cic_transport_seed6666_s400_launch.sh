...
OUTPUT="/data/datasets/wkq_vlm/gagi/eve_v2_outputs/eve_cic_transport_v1/cic_transport_seed6666_s400"
PAYLOAD="${REPO_DIR}/eveworld/tia_transport/cic_transport_seed6666_s400_kjob.sh"
